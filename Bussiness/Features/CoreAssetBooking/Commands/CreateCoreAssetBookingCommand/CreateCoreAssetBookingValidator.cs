...
{
    public class CreateCoreAssetBookingValidator
        : AbstractValidator<CreateCoreAssetBookingCommand>
    {
        #region Fields
        ...
        public CreateCoreAssetBookingValidator(ICoreAssetBookingRepository CoreAssetBookingRepository)
        {
