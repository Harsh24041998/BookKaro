...
{
    public class CreateCoreAssetSubscriptionValidator
        : AbstractValidator<CreateCoreAssetSubscriptionCommand>
    {
        #region Fields
        ...
        public CreateCoreAssetSubscriptionValidator(ICoreAssetSubscriptionRepository CoreAssetSubscriptionRepository)
        {
