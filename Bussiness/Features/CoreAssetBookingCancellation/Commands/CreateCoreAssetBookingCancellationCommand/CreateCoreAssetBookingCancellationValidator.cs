...
{
    public class CreateCoreAssetBookingCancellationValidator
        : AbstractValidator<CreateCoreAssetBookingCancellationCommand>
    {
        #region Fields
        ...
        public CreateCoreAssetBookingCancellationValidator()
        {
